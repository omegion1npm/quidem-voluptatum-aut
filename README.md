...
```
const Optist = require('@omegion1npm/quidem-voluptatum-aut');
...
Pre-made callbacks are available in util module of the @omegion1npm/quidem-voluptatum-aut package.
...
```
const Optist = require('@omegion1npm/quidem-voluptatum-aut');
const ou = require('@omegion1npm/quidem-voluptatum-aut/util');
